...
<html lang="en" dir="ltr">
 ...
 <body>
  ...
  <nav class="w3-bar">
    ...
    <a href="../"><button type="button" class="nav_btn" name="button">Home</button></a>
    <a href="../logout"><button type="button" class="nav_btn w3-hide-small" name="button">Logout</button></a>
    <a href="../about"><button type="button" class="nav_btn" name="button">About</button></a>
  </nav>

  <div class="container">
    <div class="login">
      <h2 style="text-align: center; font-family: monospace; font-weight: bold">CONFIGURE CONNECTION</h2>
          ...
          <form class="" action="" method="post">
            <table class="login_table" style="max-width: 100%;">
              ...
              <tr>
                ...
                <td class="login_table"><input type="text" class="login_input" name="login_username" value="<?php echo $user; ?>" placeholder="username" required></td>
              </tr>
              <tr>
                <td class="login_table"> <span class="login_label">Password</span> </td>
                <td class="login_table"> <input type="password" class="login_input" name="login_password" value="<?php echo $pass; ?>" placeholder="password" required> </td>
              ...
              <tr>
                ...
                <td class="login_table"> <input type="text" class="login_input" name="hostname" value="<?php echo $svnm; ?>" placeholder="localhost" required> </td>
              </tr>
              <tr>
                <td class="login_table"> <span class="login_label">Database Username</span> </td>
                <td class="login_table"> <input type="text" class="login_input" name="db_username" value="<?php echo $un; ?>" placeholder="database_username" required> </td>
              </tr>
              <tr>
                <td class="login_table"> <span class="login_label">Database Password</span> </td>
                <td class="login_table"> <input type="password" class="login_input" name="db_password" value="<?php echo $pd; ?>" placeholder="database_password" required> </td>
              </tr>
              <tr>
                <td class="login_table"> <span class="login_label">Database Name</span> </td>
                <td class="login_table"> <input type="text" class="login_input" name="db_name" value="<?php echo $db; ?>" placeholder="database_name" required> </td>
              </tr>
              <tr>
                <td class="login_table" colspan="2"> <input type="submit" name="submit_setup" value="Update" class="nav_btn"> </td>
              </tr>
            </table>
          </form>
        </center>
